  ...
  <section class="client_section layout_padding">
    <div class="container">
      ...
      <div class="carousel-wrap ">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-950px, 0px, 0px); transition: 0.25s; width: 3800px;"><div class="owl-item cloned" style="width: 455px; margin-right: 20px;"><div class="item">
            <div class="box">
              <div class="img-box">
          ...
          </div></div><div class="owl-item cloned" style="width: 455px; margin-right: 20px;"><div class="item">
            <div class="box">
              <div class="img-box">
          ...
          </div></div><div class="owl-item active" style="width: 455px; margin-right: 20px;"><div class="item">
            <div class="box">
              <div class="img-box">
                <img src="images/client1.jpg" alt="" class="box-img">
              </div>
          ...
          </div></div><div class="owl-item" style="width: 455px; margin-right: 20px;"><div class="item">
            <div class="box">
              <div class="img-box">
                <img src="images/client1.jpg" alt="" class="box-img">
              </div>
